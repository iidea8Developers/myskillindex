...
<head>
	...
	<link rel="stylesheet" href="../../css/candidate/reset1.css"> <!-- CSS reset -->
	<link rel="stylesheet" href="../../css/candidate/style1.css"> <!-- Gem style -->
	...
	<div class="modal-dialog" style="width:800px">
    	<div class="modal-content login-modal">
      		<div class="modal-header id="header1" login-modal-header" style="background:transparent;border:solid 1px #2196F3;box-shadow: 0px 0px 20px #2196F3;">
        		<button type="button" class="close" data-dismiss="modal" aria-label="Close" style="color:#000000"><span aria-hidden="true">&times;</span></button>
	      			...
	      			<div role="tabpanel" class="login-tab">
                        ...
                        <span class="glyphicon form-control-feedback" id="fname1"></span>                                                                                                
					    	...
					    	<div role="tabpanel" class="tab-pane" id="profile" >
					    		...
					    		<div class="clearfix"></div>
					    		<center><form action="../../service/candidate/register.php" method="post" enctype="multipart/form-data">
                                  ...
                                  <div class="form-group">
								    	<div class="input-group">
								      		<div class="input-group-addon"><i class="fa fa-user"></i></div>
								      		<input type="tel" class="form-control" pattern="[0-9]{12}" name="aadhar" id="Adhar" placeholder="Adhar" pattern="[0-9]{12}" 
                          required title="Adhar # is a 12 digit number">
								    	</div>
                          ...
                          <div class="checkbox"><label><input type="checkbox" value="" required/>By signing in you are agreeing to our Conditions of Use and Sale and our Privacy Notice</label>      </div>                                       
						  			<center><button type="submit" id="register_btn" class="btn btn-block bt-login" data-loading-text="Registering...." style="border:solid 1px #0074bf;width:200px;color:#0074bf;background:transparent;">Register</button></center>
									<div class="clearfix"></div>
